...
<div class="panel panel-default">
	<div class="panel-body">					
		<table>
			<tr>
				<td>甲方:</td>
				<td><input type="text" name="name" id="firstNames" class="form-control search-query name" /></td>
				<td>&nbsp;&nbsp;</td>
				<td>乙方:</td>
				<td><input type="text" name="name" id="partyNames" class="form-control search-query name" /></td>
				<td>&nbsp;&nbsp;</td>
				<td>产品名:</td>
				<td><input type="text" name="name" id="productName" class="form-control search-query name" /></td>
				<td>&nbsp;&nbsp;</td>
				<td>批次号:</td>
				<td><input type="text" name="name" id="batchNumber2" class="form-control search-query name" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td>审核:</td>
				<td><select id="ashoreCheckr" class="form-control search-query name"><option value="0">未核对</option>
						<option value="1">已核对</option></select></td>
				<td>&nbsp;&nbsp;</td>
				<td>争议:</td>
				<td><select id="type" class="form-control search-query name"><option 	value="">请选择</option>
						<option value="1">有争议数字</option></select></td>
				<td>&nbsp;&nbsp;</td>
				<td>合同开始:</td>
