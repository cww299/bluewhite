	...
	<form action="" id="layuiadmin-form-admin"
		...
		<div class="layui-form" lay-filter="layuiadmin-form-admin">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
						<input type="text" value="{{d.custom.name }}" name="customerName" id="logisticsId"
			...
			layui.config({
				...
				function() {
					...
					function addEidt(type){
						var data={custom:{name:''},logisticsDate:'',money:'',expenseDate:'',content:'',withholdMoney:'',withholdReason:''};
						var title="新增数据";
						var html="";
