			      			...
			      			for (var i = 0; i < arr.length; i++) {
			      				...
			      				htmlto = "";
			      				 ...
			      				 for (var k = 0; k < arrTo.length;k++) {
			      					...
			      					htmlto +='<a href="javascript:;">'+c+'</a>' //拼接第二层
			      					htmlth = "";
			      				if(arrTh!=null){
			      					for (var j = 0; j < arrTh.length; j++) {
										...
										htmlth +='<dd><a lay-href="set/system/email.html">'+e+'</a></dd>'
					                    //拼接第三层
									}
			      				}
			      				htmltr +='<dd class="layui-nav-itemed"><a href="'+d+'">'+c+'</a><dl class="layui-nav-child">'+htmlth+'</d1></dd>'
								} 
			      				 }
			      			html +='<li class="layui-nav-item"><a href="javascript:;" lay-tips="设置" lay-direction="2">'
			                    +'<i class="layui-icon layui-icon-set"></i>'
			                    +'<cite>'+a+'</cite></a>'
			                    +'<dl class="layui-nav-child">'+htmltr+''
			                    +'</li>'
							}
