			...
			<div class="tab-content">
				...
				<div class="tab-pane active" id="home1">
					...
					<table>
						<tr>
							<td>员工姓名:</td>
							<td><input type="text" name="name" id="usernameth" placeholder="请输入姓名"
								class="form-control search-query name" /></td>
							<td>&nbsp&nbsp&nbsp&nbsp</td>
							<td>开始时间:</td>
							<td><input id="startTimeth" placeholder="请输入考勤开始时间" class="form-control laydate-icon"
								onClick="laydate({elem: '#startTimeth', istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
							</td>
							<td>&nbsp&nbsp&nbsp&nbsp</td>
							<td>结束时间:</td>
							<td><input id="endTimeth" placeholder="请输入考勤结束时间" class="form-control laydate-icon"
								onClick="laydate({elem: '#endTimeth', istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
							</td>
							<td>&nbsp&nbsp&nbsp&nbsp</td>
							<td><span class="input-group-btn">
								<button type="button" class="btn btn-info btn-square btn-sm btn-3d searchtaskth"> 查&nbsp找</button></span></td>
							<td>&nbsp&nbsp&nbsp&nbsp</td> 
							<td><span class="input-group-btn">
								<button type="button" class="btn btn-danger  btn-sm btn-3d start">一键删除</button></span></td>
						</tr>
					</table>
				...
				<div class="tab-pane" id="profile1">
					...
					<table>
						<tr>
							...
							<td>&nbsp&nbsp&nbsp&nbsp</td>
							<td>姓名:</td>
							<td><input type="text" name="name" id="username" placeholder="请输入姓名"
								class="form-control search-query name" /></td>
							<td>&nbsp&nbsp&nbsp&nbsp</td>
							<td>开始:</td>
				...
				<div class="tab-pane" id="profile2">
					...
					<table>
						<tr>
							...
							<td>&nbsp&nbsp&nbsp&nbsp</td>
							<td><span class="input-group-btn">
								<button type="button"class="btn btn-info btn-square btn-sm btn-3d searchtasktw">查找
								 <i class="icon-search icon-on-right bigger-110"></i></button></span></td>
						</tr>
					</table>
					<h1 class="page-header"></h1>
			      		  ...
			      		  success: function (result) {
			      			...
			      			$("#totaltr2").text(result.data.statData.stateCount)
			      			 $(result.data.rows).each(function(i,o){
			      				...
			      				+'<td class="text-center edit ">'+o.allotTime+'</td>'
			      				+'<td class="text-center edit ">'+parseFloat((o.performancePayNumber==null ? 0 : o.performancePayNumber).toFixed(4))+'</td>'
			      				+'<td class="text-center edit ">'+parseFloat((o.payNumber==null ? 0 : o.payNumber).toFixed(4))+'</td></tr>'
