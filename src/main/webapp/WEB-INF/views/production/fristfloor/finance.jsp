				...
				<div class="tab-pane active" id="home1">
					...
					<table>						
						<tr>
							...
							<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>开始时间:</td>
							<td><input id="startTimeth"
								placeholder="请输入考勤开始时间"
								class="form-control laydate-icon"
								onClick="laydate({elem: '#startTimeth', istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
							</td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>结束时间:</td>
							<td><input id="endTimeth" placeholder="请输入考勤结束时间"
								class="form-control laydate-icon"
				...
				<div class="tab-pane" id="profile1">
					...
					<table>
						<tr>
							...
							<td>&nbsp;&nbsp;</td>
							<td><span class="input-group-btn">
									<button type="button" class="btn btn-info btn-square btn-sm btn-3d searchtask"> 查找 <i class="icon-search icon-on-right bigger-110"></i></button></span></td>
						</tr>
					</table>
						...
						<tr>
							...
							<td>
								<span class="input-group-btn">
									<button type="button" class="btn btn-info btn-square btn-sm btn-3d searchtasktw"> 查找 <i class="icon-search icon-on-right bigger-110"></i>
									</button></span>
							</td>
						</tr>
					</table>
			      		  ...
			      		  success: function (result) {
			      			...
			      			$("#totaltr2").text(result.data.statData.stateCount)
			      			 $(result.data.rows).each(function(i,o){
			      				...
			      				+'<td class="text-center edit ">'+o.allotTime+'</td>'
			      				+'<td class="text-center edit ">'+parseFloat((o.performancePayNumber==null ? 0 :o.performancePayNumber).toFixed(3))+'</td>'
