	...
	<div class="panel-body">
		<div class="tab-wrapper tab-primary">
			<ul class="nav nav-tabs col-md-12">
				<li class="active col-md-4"><a href="#home1" data-toggle="tab">绩效流水</a></li>
				<li class="col-md-4"><a href="#profile1" data-toggle="tab">绩效汇总</a></li>
				<li class="col-md-4"><a href="#profile2" data-toggle="tab">质检月产量报表</a></li>
			</ul>
			<div class="tab-content">
				...
				<div class="tab-pane active" id="home1">
					...
					<table>
						<tr>
							<td>我想上浮下调比例:</td>
							<td><input type="text" name="name" id="usernameth" placeholder="请输入比例"
								class="form-control search-query name" /></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>无加绩的配合奖励:</td>
							<td><input type="text" name="name" id="code" placeholder="请输入奖励"
								class="form-control search-query name" /></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>开始时间:</td>
							<td><input id="startTimeth" placeholder="请输入开始时间" class="form-control laydate-icon"
								onClick="laydate({elem: '#startTimeth', istime: true, format: 'YYYY-MM-DD 00:00:00'})"></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>结束时间:</td>
							<td><input id="endTimeth" placeholder="请输入结束时间"
								class="form-control laydate-icon"
								onClick="laydate({elem: '#endTimeth', istime: true, format: 'YYYY-MM-DD 23:59:59'})">	</td>
							<td>&nbsp;&nbsp;</td>
							<td>
					...
					<table class="table table-hover">
						<thead>
							<tr>
								...
								<th class="text-center">手动调节加绩</th>
				...
				<div class="tab-pane" id="profile2">
					...
					<table>
						<tr>
							...
							<td>
								<span class="input-group-btn">
									<button type="button" class="btn btn-info btn-square btn-sm btn-3d searchtasktw">查&nbsp找</button></span></td>
						</tr>
					</table>
					<!-- 查询结束 -->
					<table class="table table-hover">
				      ...
				      beforeSend:function(){
		      		  ...
		      		  success: function (result) {
		      			 $(result.data).each(function(i,o){
		      				...
		      				+'<td class="text-center edit ">'+parseFloat((o.addPerformancePay*1).toFixed(3))+'</td></tr>'
