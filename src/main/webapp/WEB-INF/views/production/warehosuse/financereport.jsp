...
<div class="layui-tab layui-tab-card">
  <ul class="layui-tab-title">
    <li class="layui-this" id="pyA" style="width: 30%">绩效流水</li>
    <li id="pyB" style="width: 30%">绩效汇总</li>
    <li id="pyc" style="width: 30%">质检月产量报表</li>
  </ul>
			...
			<div class="layui-form layui-card-header layuiadmin-card-header-auto">
				<div class="layui-form-item">
					<table>
						<tr>
							<td>我想上浮下调比例:</td>
							<td><input   name="addNumber" placeholder="请输入比例" class="layui-input laydate-icon">
							</td>
							<td>&nbsp;&nbsp;</td>
							<td>无加绩的配合奖励:</td>
							<td><input   name="noPerformancePay" placeholder="请输入奖励" class="layui-input laydate-icon">
							</td>
							<td>&nbsp;&nbsp;</td>
							<td>时间:</td>
