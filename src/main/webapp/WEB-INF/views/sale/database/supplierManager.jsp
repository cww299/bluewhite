...
<div class="layui-card">
	<div class="layui-card-body">
		<table class="layui-form">
			<tr>
				<td><input type="text" name="name" class="layui-input" placeholder="供应商名称"></td>
				<td>&nbsp;&nbsp;</td>
...
<div  class="layui-button-container">
	<span lay-event="add"  class="layui-btn layui-btn-sm" >新增供应商</span>
	<span lay-event="delete"  class="layui-btn layui-btn-sm layui-btn-danger" >删除供应商</span>
	<span lay-event="update"  class="layui-btn layui-btn-sm" >修改供应商信息</span>
</div>
</script>
<script>
layui.config({
	...
	function(){
		...
		table.render({
			elem:'#customTable',
			url:'${ctx}/ledger/customerPage?type=4',
