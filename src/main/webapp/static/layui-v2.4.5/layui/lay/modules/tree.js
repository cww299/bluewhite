...
function(e) {
    ...
    b.prototype.tree = function(e, a) {
        ...
        function(a, r) {
            ...
            o = i('<div class="layui-tree-pack" ' + (r.spread ? 'style="display: block;"': 'style="display: none;"') + '"></div>'),
            ...
            function() {
                return t.showLine ? l ? '<span class="layui-tree-iconClick layui-tree-icon"><i class="layui-icon ' + (r.spread ? "layui-icon-subtraction": "layui-icon-addition") + '"></i></span>': '<span class="layui-tree-iconClick"><i class="layui-icon layui-icon-file ' + (s==false ? "": c) + '"></i></span>': '<span class="layui-tree-iconClick"><i class="layui-tree-iconArrow ' + (l ? "": c) + '"></i></span>'
            } (),
            function() {
