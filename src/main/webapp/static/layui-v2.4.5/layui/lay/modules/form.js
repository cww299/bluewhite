  ...
  Form.prototype.render = function(type, filter){
    ...
    ,items = {
      ...
      select: function(){
        ...
        //各种事件
        ,events = function(reElem, disabled, isSearch,originalElem,onlineSelect){
          var select = $(this)
        ...
        selects.each(function(index, select){
          ...
          //扩展在线搜索
          var onlineSelect = othis.attr('lay-url')?{
    		 url : othis.attr('lay-url') || false,
    		 searchName : othis.attr('lay-searchName') || 'name',
           	 showId : othis.attr('lay-value') || 'id',
         	 showName : othis.attr('lay-name') || 'name',
          }:null;
          ...
          othis.after(reElem);          
          events.call(this, reElem, disabled, isSearch, othis,onlineSelect);	//将 othis 未渲染的元素扩展出去。方便在线搜索添加
        });
      }
