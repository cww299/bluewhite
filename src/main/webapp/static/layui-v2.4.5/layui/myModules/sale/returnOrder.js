...
layui.extend({
	...
	var TPL = ['<div class="layui-form layui-form-pane" style="padding:20px;">',
				...
				'</div>',
				'<div class="layui-item" pane>',
					'<label class="layui-form-label"><b class="red">*</b>退货日期</label>',
					'<div class="layui-input-block">',
				...
				'</div>',
				'<div class="layui-item" pane>',
					'<label class="layui-form-label"><b class="red">*</b>工序</label>',
					'<div class="layui-input-block">',
				...
				'</div>',
				'<div class="layui-item" pane>',
					'<label class="layui-form-label"><b class="red">*</b>退货数量</label>',
					'<div class="layui-input-block">',
