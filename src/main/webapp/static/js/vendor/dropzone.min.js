    ...
    function(a, b, c) { (function() {
            ...
            a = function(a) {
                ...
                b.prototype.defaultOptions = {
                    ...
                    dictFileTooBig: "File is too big ({{filesize}}MiB). Max filFesize: {{maxFilesize}}MiB.",
                    ...
                    init: function() {
                    	...
                    	this.on("success",function(file,data){
                    		...
                    		arr =$(this)
                    		arra=arr[0].element.childNodes
                    		ss=arra[arra.length-1]
                    		aa=ss.children[2]
                    		aa.setAttribute("data-id",data.data.id)
                    ...
                    addedfile: function(a) {
                        ...
                        for (this.options.addRemoveLinks && (a._removeLink = b.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>' + this.options.dictRemoveFile + "</a>"), a.previewElement.appendChild(a._removeLink)), d = function(c) {
                            ...
                            c.stopPropagation(),
                            a.status === b.UPLOADING ? b.confirm(p.options.dictCancelUploadConfirmation,
                            function() {
                ...
                b.prototype._addFilesFromItems = function(a) {
                    ...
                    null != c.webkitGetAsEntry && (b = c.webkitGetAsEntry()) ? b.isFile ? f.push(this.addFile(c.getAsFile())) : b.isDirectory ? f.push(this._addFilesFromDirectory(b, b.name)) : f.push(void 0) : null != c.getAsFile ? null == c.kind || "file" === c.kind ? f.push(this.addFile(c.getAsFile())) : f.push(void 0) : f.push(void 0);
                    return f
                },
                ...
                b.prototype._processThumbnailQueue = function() {
                    ...
                    this.createThumbnail(this._thumbnailQueue.shift(),
                    function() {
                ...
                b.prototype.createThumbnail = function(a, b) {
                    ...
                    c.onload = function() {
                        ...
                        e.onload = function() {
                            ...
                            null == g.trgWidth && (g.trgWidth = d.options.thumbnailWidth),
                            null == g.trgHeight && (g.trgHeight = d.options.thumbnailHeight),
