...
private static final Log log = Log.getLog(BacthAction.class);
...

	{
		clearCascadeJSON = ClearCascadeJSON
				.get()
				.addRetainTerm(Bacth.class,"id","receive","sumReworkPrice","sumTaskPrice","regionalPrice","name","allotTime","number","createdAt","remarks","status","bacthDepartmentPrice","bacthHairPrice","bacthNumber","price","type","product")
