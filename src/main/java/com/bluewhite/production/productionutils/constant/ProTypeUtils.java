...
public class ProTypeUtils {
	...
	private static double getAC8() {
		return NumUtils.div(
				NumUtils.mul(proTypeUtils.service.findByExcelNameAndType("AC5", 1).getNumber() * ProTypeUtils.EXCELONE,
	...
	private static double getAD12() {
		return NumUtils.sub(
				NumUtils.mul(proTypeUtils.service.findByExcelNameAndType("AC5", 1).getNumber(),
	...
	private static double getPackAC8() {
		return NumUtils.div(
				NumUtils.mul(proTypeUtils.service.findByExcelNameAndType("AC5", 2).getNumber() * ProTypeUtils.EXCELONE,
	...
	private static double getBZAD12() {
		return NumUtils.sub(
				NumUtils.mul(proTypeUtils.service.findByExcelNameAndType("AC5", 2).getNumber(),
	...
	private static double getAC8N() {
		return NumUtils.div(
				NumUtils.mul(proTypeUtils.service.findByExcelNameAndType("AC5", 5).getNumber() * ProTypeUtils.EXCELONE,
	...
	private static double getAC8TWO() {
		return NumUtils.div(
				NumUtils.mul(proTypeUtils.service.findByExcelNameAndType("AC5", 3).getNumber() * ProTypeUtils.EXCELONE,
