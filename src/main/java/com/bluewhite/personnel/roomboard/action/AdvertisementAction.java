...
public class AdvertisementAction {
	...
	private ClearCascadeJSON clearCascadeJSON;
	{
		clearCascadeJSON = ClearCascadeJSON.get()
				.addRetainTerm(Advertisement.class,"id","time","platformId","platform", "price","startTime","endTime","recruitId","recruitName","train","trainPrice","userId","user","qualified","type","number","number1","number2","number3","number4")
