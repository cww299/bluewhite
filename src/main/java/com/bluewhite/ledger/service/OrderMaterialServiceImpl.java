                        ...
                        if (cutPartsList.size() > 0) {
                            cutPartsList.forEach(c -> {
                                ...
                                if (c.getComposite() == 1) {
                                    ...
                                    Materiel materiel = materielService.findOne(c.getMaterielId());
                                    orderMaterialComposite.setCutPartsName(orderMaterial.getCutPartsName() + materiel.getName());
