...
public class OrderAction {
...

	{
		clearCascadeJSON = ClearCascadeJSON
				.get()
				.addRetainTerm(Order.class,"id","salesNumber","contractTime","batchNumber","planNumbers","productName","contractNumber","contractPrice","remarksPrice","firstNames","partyNames","price","firstNamesId","partyNamesId","contact","ashoreNumber","ashoreTime","ashoreCheckr","disputeNumber","roadNumber","disputePrice","ashorePrice")
