...
public interface AttendancePayDao extends BaseRepository<AttendancePay, Long>{
	 ...
	 * @return
	 */
	List<AttendancePay> findByUserIdInAndTypeAndAllotTimeBetween(List<Long> ids, Integer type, Date orderTimeBegin,
			Date orderTimeEnd);
	 ...
	 * @return
	 */
	AttendancePay findByIdAndUserId(Long  id,Long userId );
